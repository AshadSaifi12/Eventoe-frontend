...
function SignUp(){
    ...
    return(
        <div className='signUp'>
            ...
            <Link className="signupLink" to='/CompanySignup' onMouseLeave={(e)=>handleDown(e.target.id)} onMouseEnter={(e)=>handleMouse(e.target.id)} id="companySignupLink"><h1>Company</h1></Link>
